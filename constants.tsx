...
export const PAGE_NAMES: { [key in Page]: string } = {
  ...
  [Page.Editor]: "投稿を作成",
  [Page.Calendar]: "カレンダー",
  [Page.BrandKit]: "ブランドキット",
  [Page.Settings]: "設定",
  [Page.Analytics]: "分析",
  [Page.TrendAnalysis]: "バズ投稿分析",
};

export const POST_STATUS_NAMES: { [key in PostStatus]: string } = {
  [PostStatus.Draft]: "下書き",
  [PostStatus.Review]: "レビュー中",
  [PostStatus.Approved]: "承認済み",
  [PostStatus.Scheduled]: "予約済み",
  [PostStatus.Posted]: "投稿済み",
...
export const MOCK_POSTS: Post[] = [
  {
    ...
    caption: "山の静かな美しさを探検。自然はいつも私たちを驚かせてくれます！🌲🏔️ #山が好き #自然写真 #冒険",
  ...
  },
  {
    ...
    caption:
      "新しいコレクションが登場しました！これらの鮮やかなデザインをチェックしてください。✨ #新コレクション #ファッションリール #デザイン",
  ...
  },
  {
    ...
    caption:
      "居心地の良いコーナーと良い本。あなたの好きなリラックス方法は何ですか？📚 #癒やしの空間 #読書スペース #インテリア",
